...
M3 makes finalized transcription segments canonical in a bounded, memory-only meeting store. Stable PARLIANT segment IDs are assigned in arrival order. Provider segment IDs are retained only for duplicate suppression and provenance.
